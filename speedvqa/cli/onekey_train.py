...
def main() -> int:
    ...
    train_dir = data_cfg.get("dataset_path_train")
    val_dir = data_cfg.get("dataset_path_val")

    if train_dir and val_dir:
        train_ds = build_dataset(str(train_dir), config, split="train")
        val_ds = build_dataset(str(val_dir), config, split="val")
    else:
